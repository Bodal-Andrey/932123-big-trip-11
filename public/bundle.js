...
/* harmony import */ var _models_event_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/event.js */ "./src/models/event.js");
...
const API = class {
  ...
  getData() {
    ...
    .then((responses) => {
      ...
      _store_js__WEBPACK_IMPORTED_MODULE_1__["default"].setDestinations(destinations);
      _store_js__WEBPACK_IMPORTED_MODULE_1__["default"].setOffers(offers);
      return points;
    })
    .then(_models_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvents);
  }
  ...
  getOffers() {
    return this._load({url: `offers`})
      .then((response) => response.json())
      .then(_store_js__WEBPACK_IMPORTED_MODULE_1__["default"].setOffers);
  }

  getDestinations() {
    return this._load({url: `destinations`})
      .then((response) => response.json())
      .then(_store_js__WEBPACK_IMPORTED_MODULE_1__["default"].setDestinations);
  }

  createPoint(id, data) {
    return this._load({
      url: `points/${id}`,
      method: _const_js__WEBPACK_IMPORTED_MODULE_2__["Method"].POST,
      body: JSON.stringify(data.toRAW()),
      headers: new Headers({"Content-Type": `application/json`})
    })
    .then((response) => response.json())
    .then(_models_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvent);
  }

  updatePoint(id, data) {
    return this._load({
      url: `points/${id}`,
      method: _const_js__WEBPACK_IMPORTED_MODULE_2__["Method"].PUT,
      body: JSON.stringify(data.toRAW()),
      headers: new Headers({"Content-Type": `application/json`})
    })
    .then((response) => response.json())
  ...
  deletePoint(id) {
    return this._load({
      url: `points/${id}`,
      method: _const_js__WEBPACK_IMPORTED_MODULE_2__["Method"].DELETE,
    });
  }

  _load({url, method = _const_js__WEBPACK_IMPORTED_MODULE_2__["Method"].GET, body = null, headers = new Headers()}) {
...
class Cost extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/***/ "./src/components/event-edit-item.js":
/*!*******************************************!*\
  !*** ./src/components/event-edit-item.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventEditItem; });
/* harmony import */ var _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-smart-component.js */ "./src/components/abstract-smart-component.js");
...
class EventEditItem extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _applyFlatpickr() {
    ...
    this._flatpickrStart = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(startDateElement, Object.assign(options, {defaultDate: this._card.startDate}));

    const endDateElement = this.getElement().querySelector(`#event-end-time-1`);
    this._flatpickrEnd = flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(endDateElement, Object.assign(options, {defaultDate: this._card.endDate}));
  }
...
const createEventItemTemplate = (card) => {
  ...
  const startDateMarkup = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(startDate);
  const endDateMarkup = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(endDate);
  const timeDiff = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["timeDifference"])(endDate, startDate);
...
class EventItem extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(card) {
    super();
    this._card = card;
  }
...
/***/ "./src/components/events-board.js":
/*!****************************************!*\
  !*** ./src/components/events-board.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventsBoard; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class EventsBoard extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class Loading extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/no-trip-item.js":
/*!****************************************!*\
  !*** ./src/components/no-trip-item.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NoTripItem; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class NoTripItem extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createSortTemplate = () => {
  return (
    `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      ...
      <label class="trip-sort__btn" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT}" for="sort-event">Event</label>
      </div>
  
      <div class="trip-sort__item  trip-sort__item--time">
      <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time">
      <label class="trip-sort__btn" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME}" for="sort-time">
          Time
      ...
      <label class="trip-sort__btn" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE}" for="sort-price">
          Price
          <svg class="trip-sort__direction-icon" width="8" height="10" viewBox="0 0 8 10">
            <path d="M2.888 4.852V9.694H5.588V4.852L7.91 5.068L4.238 0.00999987L0.548 5.068L2.888 4.852Z"/>
          </svg>
...
class Sort extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].EVENT;
  }
...
class Statistics extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _renderTransportChart(transportCtx) {
    ...
    return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(transportCtx, {
      ...
      type: `horizontalBar`,
      data: {
        labels: Object.keys(this._transportEvents).map((transportEvent) => _const_js__WEBPACK_IMPORTED_MODULE_1__["ChartTypeLabelsMap"][transportEvent]),
        datasets: [{
  ...
  _getTripEventsChartData() {
    const tripEventsChartData = this._tripEventsTypes.map((event) => {
      return {
        type: event,
        label: _const_js__WEBPACK_IMPORTED_MODULE_1__["ChartTypeLabelsMap"][event],
  ...
  _getTimeSpend(tripEventType) {
    ...
    let differenceInHours = Math.round(totalDifference / _const_js__WEBPACK_IMPORTED_MODULE_1__["TimeInMs"].HOUR);
    return differenceInHours;
  }

  _getTransportEvents() {
    const transportEvents = [];
    _const_js__WEBPACK_IMPORTED_MODULE_1__["TRANSPORT_TYPES"].forEach((type) => {
      this._events.forEach((event) => {
        if (event.type === type) {
...
class Trip extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(eventsModel) {
    super();
    this._eventsModel = eventsModel;
    this._events = this._eventsModel.getEvents();
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: SortType, FilterType, MenuItem, eventActions, ChartTypeLabelsMap, TimeInMs, ServerUrl, Method, TRANSPORT_TYPES, EVENT_TYPES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChartTypeLabelsMap", function() { return ChartTypeLabelsMap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimeInMs", function() { return TimeInMs; });
...
class FilterController {
  ...
  render() {
    ...
    this._filterComponent = new _components_filters_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters);
    this._filterComponent.setFilterChangeHandler(this._onFilterChange);

    if (oldComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._filterComponent, oldComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["renderElement"])(container, this._filterComponent);
    }
  }
...
/* harmony import */ var _components_event_edit_item_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/event-edit-item.js */ "./src/components/event-edit-item.js");
/* harmony import */ var _components_event_item_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/event-item.js */ "./src/components/event-item.js");
/* harmony import */ var _models_event_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/event.js */ "./src/models/event.js");
...
const EmptyEvent = {
  id: Object(_mock_cards_js__WEBPACK_IMPORTED_MODULE_5__["generateCard"])().id,
  type: Object(_mock_cards_js__WEBPACK_IMPORTED_MODULE_5__["generateCard"])().type,
  city: ``,
  startDate: Date.now(),
  endDate: Date.now(),
  nowDate: new Date(),
...
const parseFormData = (formData) => {
  return new _models_event_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
    "type": formData.get(`event-type`),
    "city": formData.get(`event-destination`),
    "startDate": moment__WEBPACK_IMPORTED_MODULE_3___default()(formData.get(`event-start-time`), `DD/MM/YY HH:mm`).valueOf(),
    "endDate": moment__WEBPACK_IMPORTED_MODULE_3___default()(formData.get(`event-end-time`), `DD/MM/YY HH:mm`).valueOf(),
...
class PointController {
  ...
  renderPoint(event, mode) {
    ...
    this._eventItem = new _components_event_item_js__WEBPACK_IMPORTED_MODULE_1__["default"](event);
    this._eventEditItem = new _components_event_edit_item_js__WEBPACK_IMPORTED_MODULE_0__["default"](event);

    this._eventEditItem.setFavoriteHandler(() => {
      const newEvent = _models_event_js__WEBPACK_IMPORTED_MODULE_2__["default"].clone(event);
    ...
    switch (mode) {
      case Mode.DEFAULT:
        if (oldEventEditItem && oldEventItem) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._eventItem, oldEventItem);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._eventEditItem, oldEventEditItem);
          this._eventEditItemToEventItem();
        } else {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["renderElement"])(this._container.getElement().querySelector(`.trip-events__list`), this._eventItem);
        }
        break;
      case Mode.ADDING:
        if (oldEventEditItem && oldEventItem) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(oldEventItem);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(oldEventEditItem);
        }
        document.addEventListener(`keydown`, this._onEscKeyDown);
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["renderElement"])(this._container, this._eventEditItem, `afterbegin`);
        break;
    }
  }

  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._eventEditItem);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._eventItem);
    document.removeEventListener(`keydown`, this._onEscKeyDown);
  }
  ...
  _eventEditItemToEventItem() {
    ...
    if (document.contains(this._eventEditItem.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._eventItem, this._eventEditItem);
    }
    this._mode = Mode.DEFAULT;
  }
  ...
  _eventItemToEventEditItem() {
    this._onViewChange();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._eventEditItem, this._eventItem);
...
/* harmony import */ var _components_event_item_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/event-item.js */ "./src/components/event-item.js");
/* harmony import */ var _components_no_trip_item_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/no-trip-item.js */ "./src/components/no-trip-item.js");
/* harmony import */ var _mock_cards_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../mock/cards.js */ "./src/mock/cards.js");
...
/* harmony import */ var _point_controller_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./point-controller.js */ "./src/controllers/point-controller.js");
...
const renderEvents = (events, tripDay, onDataChange, onViewChange, isDefaultSorting = true) => {
  ...
  dates.forEach((date, dateIndex) => {
    const day = isDefaultSorting ? new _components_day_js__WEBPACK_IMPORTED_MODULE_0__["default"](date, dateIndex + 1) : new _components_day_js__WEBPACK_IMPORTED_MODULE_0__["default"]();

    events.filter((_card) => {
      return isDefaultSorting ? new Date(_card.startDate).toDateString() === date : _card;
    }).forEach((_card) => {
      const pointController = new _point_controller_js__WEBPACK_IMPORTED_MODULE_8__["default"](day, onDataChange, onViewChange);
      pointController.renderPoint(_card, _point_controller_js__WEBPACK_IMPORTED_MODULE_8__["Mode"].DEFAULT);
      pointControllers.push(pointController);
    });

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["renderElement"])(tripDay.getElement(), day);
  });
...
class TripController {
  constructor(container, eventsModel, api) {
    ...
    this._sortComponent = new _components_sort_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._daysComponent = new _components_days_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._noTripItemComponent = new _components_no_trip_item_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._eventItem = new _components_event_item_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._sortType = _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].EVENT;
  ...
  render() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["renderElement"])(this._container, this._sortComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["renderElement"])(this._container, this._daysComponent);

    if (events.length === 0) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["renderElement"])(this._container, this._noTripItemComponent, `beforeend`);
      return;
    }
  ...
  createEvent() {
    ...
    this._creatingEvent = new _point_controller_js__WEBPACK_IMPORTED_MODULE_8__["default"](this._daysComponent.getElement(), this._onDataChange, this._onViewChange);
    this._creatingEvent.renderPoint(_point_controller_js__WEBPACK_IMPORTED_MODULE_8__["EmptyEvent"], _point_controller_js__WEBPACK_IMPORTED_MODULE_8__["Mode"].ADDING);
    this._onViewChange();
  }

  _setDefaultBoardMode() {
    this._sortType = _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].EVENT;
    this._eventsModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_6__["FilterType"].EVERYTHING);
  }
  ...
  _onSortTypeChange(sortType) {
    ...
    switch (sortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].TIME:
        sortedEvents = _mock_cards_js__WEBPACK_IMPORTED_MODULE_5__["cards"].slice().sort((a, b) => (b.endDate - b.startDate) - (a.endDate - a.startDate));
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].PRICE:
        sortedEvents = _mock_cards_js__WEBPACK_IMPORTED_MODULE_5__["cards"].slice().sort((a, b) => b.price - a.price);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].EVENT:
        sortedEvents = _mock_cards_js__WEBPACK_IMPORTED_MODULE_5__["cards"].slice();
  ...
  _onDataChange(pointController, oldData, newData) {
    if (oldData === _point_controller_js__WEBPACK_IMPORTED_MODULE_8__["EmptyEvent"]) {
      this._creatingEvent = null;
      if (newData === null) {
      ...
      .then((eventModel) => {
        ...
        if (isSuccess) {
          pointController.renderPoint(newData, _point_controller_js__WEBPACK_IMPORTED_MODULE_8__["Mode"].DEFAULT);
        }
      });
    }
  }
...
/* harmony import */ var _components_trip_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/trip.js */ "./src/components/trip.js");
/* harmony import */ var _components_cost_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/cost.js */ "./src/components/cost.js");
...
/* harmony import */ var _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/filter-controller.js */ "./src/controllers/filter-controller.js");
/* harmony import */ var _models_events_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/events.js */ "./src/models/events.js");
/* harmony import */ var _components_events_board_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/events-board.js */ "./src/components/events-board.js");
/* harmony import */ var _components_loading_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/loading.js */ "./src/components/loading.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _components_statistics_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/statistics.js */ "./src/components/statistics.js");
/* harmony import */ var _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./controllers/trip-controller.js */ "./src/controllers/trip-controller.js");
...
const menuComponent = new _components_menu_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const api = new _api_js__WEBPACK_IMPORTED_MODULE_0__["default"](SERVER_URL, AUTHORIZATION);
const eventsModel = new _models_events_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
const loading = new _components_loading_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
const filterController = new _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](siteTripControlsElement, eventsModel);
const trip = new _components_trip_js__WEBPACK_IMPORTED_MODULE_1__["default"](eventsModel);
const cost = new _components_cost_js__WEBPACK_IMPORTED_MODULE_2__["default"](eventsModel);
const eventsBoard = new _components_events_board_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
const tripController = new _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_10__["default"](eventsBoard, eventsModel, api);
const statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_9__["default"](eventsModel);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(siteTripControlsElement, menuComponent, `afterbegin`);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(pageBodyContainer, loading);
filterController.render();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(pageBodyContainer, eventsBoard, `afterbegin`);

document.querySelector(`.trip-main__event-add-btn`).addEventListener(`click`, () => {
  tripController.createEvent();
});

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(pageBodyContainer, statisticsComponent, `beforeend`);
statisticsComponent.hide();

menuComponent.setOnChange((menuItem) => {
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_11__["MenuItem"].STATS:
      menuComponent.setActiveItem(menuItem);
      tripController.hide();
      statisticsComponent.show();
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_11__["MenuItem"].TABLE:
      menuComponent.setActiveItem(menuItem);
      statisticsComponent.hide();
      tripController.show();
  }
...
api.getData()
  .then((events) => {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(loading);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(siteTripMainElement, trip, `afterbegin`);
    const siteTripInfoElement = siteTripMainElement.querySelector(`.trip-info`);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["renderElement"])(siteTripInfoElement, cost, `beforeend`);
...
/*!***************************!*\
  !*** ./src/mock/cards.js ***!
  \***************************/
/*! exports provided: cards, generateCard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const getRandomArray = (arr, min, max) => {
  ...
  for (let i = 0; (i < Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(min, max)) && (i < arr.length); i++) {
...
const getRandomDate = () => {
  return (
    Date.now() + 1 + Math.floor(Math.random() * 7) * 24 * Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 60) * 60 * 1000
  );
};
...
const generateCard = () => {
  ...
  return {
    ...
    type: types[Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, types.length - 1)],
    city: cities[Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, cities.length - 1)],
    startDate: Math.min(startDate, endDate),
    endDate: Math.max(startDate, endDate),
    nowDate: new Date(),
    price: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(10, 100),
...
class Events {
  ...
  getEvents() {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["getEventsByFilter"])(this._events, this._activeFilterType);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: formatDate, formatTime, timeDifference, getRandomInteger */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const formatDate = (data) => {
  const calend = moment__WEBPACK_IMPORTED_MODULE_0___default()(data).format(`L`);
  const time = moment__WEBPACK_IMPORTED_MODULE_0___default()(data).format(`hh:mm`);

  return `${calend} ${time}`;
};

const formatTime = (data) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(data).format(`hh:mm`);
};

const timeDifference = (endTime, startTime) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.utc(moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(endTime) - moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(startTime)).format(`D[D] hh[H] mm[M]`);
};
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getFutureEvents, getPastEvents, getEventsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFutureEvents", function() { return getFutureEvents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPastEvents", function() { return getPastEvents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEventsByFilter", function() { return getEventsByFilter; });
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: createElement, renderElement, replace, remove */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
